<%@ Page Title="" Language="C#" MasterPageFile="~/PageMaster.Master" AutoEventWireup="true" CodeBehind="register.aspx.cs" Inherits="laptopshop_master.register" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="cphProductsddetails" runat="server">
</asp:Content>
<asp:Content ID="Content6" ContentPlaceHolderID="cphregister" runat="server">
    <div id="mainBody">
	<div class="container">
	<div class="row">
<!-- Sidebar ================================================== -->
